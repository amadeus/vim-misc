...
if !exists("html_no_rendering")
  ...
  syn region htmlLink start="<a\>\_[^>]*\<href\>" end="</a>"me=e-4 contains=@Spell,htmlTag,htmlEndTag,htmlSpecialChar,htmlPreProc,htmlComment,htmlLeadingSpace,@htmlPreproc
...
if main_syntax != 'java' || exists("java_javascript")
  ...
  " Save current syntax first - fixes proper inheritance
  let syntax_save = main_syntax
  syn include @htmlJavaScript syntax/javascript.vim
  " Cleanup by resetting main_syntax and removing the save
  let main_syntax = syntax_save
  unlet syntax_save
